...
import org.ipc.dahua.commcon.NetSDKLib.LLong;
...
public class ToolKits {
	...
	public static String getErrorCodeShow() {
		...
		return ErrorCode.getErrorCode(Module.netsdk.CLIENT_GetLastError());
		//return "";
	}
	...
	public static String getErrorCodePrint() {
		return "\n{error code: (0x80000000|" + (Module.netsdk.CLIENT_GetLastError() & 0x7fffffff) +").参考  NetSDKLib.java }"
				+ " - {error info:" + ErrorCode.getErrorCode(Module.netsdk.CLIENT_GetLastError()) + "}\n";
	}
